...
class Settings:
    ...
    assistant_model: str = field(default_factory=lambda: os.getenv('OPENAI_ASSISTANT_MODEL', 'gpt-4.1-mini'))
    ...
    voice: str = field(default_factory=lambda: os.getenv('OPENAI_TTS_VOICE', 'marin'))
